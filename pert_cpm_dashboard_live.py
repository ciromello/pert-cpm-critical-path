...
# -------------------------
# Top Toolbar (Upload / Download / Save)
# -------------------------
col_title, col_spacer, col_upload, col_download, col_save = st.columns([5, 1, 1, 1, 1])
...
st.sidebar.markdown("### 📁 File Controls")
...
if uploaded_file is not None:
    ...
    st.session_state["saved_df"] = df_uploaded
...
# Update session only (no forced file write)
